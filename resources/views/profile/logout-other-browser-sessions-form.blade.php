<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Atur dan logout sesi yang aktif pada browser dan perangkat lain.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Jika dibutuhkan, anda dapat logout dari seluruh sesi login yang aktif pada semua perangkat. Jika anda merasa akun ini telah digunakan pihak lain, sebaiknya anda juga mengganti password login dengan password baru.') }}
        </div>
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Logout Browser Sessions yang lain') }}
            </x-jet-button>
