	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="flex justify-between h-16">
			<div class="flex">
				...
				<div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
					<x-jet-nav-link href="{{ route('dashboard.profile') }}" :active="request()->routeIs('dashboard.profile') || request()->routeIs('profile.*')">
						{{ __('Profil') }}
					</x-jet-nav-link>
				</div>
				@endif
					...
					<x-jet-dropdown align="right" width="48">
						...
						<x-slot name="content">
							...
							<form method="POST" action="{{ route('logout') }}">
								...
								<x-jet-dropdown-link class="font-semibold text-red-600" href="{{ route('logout') }}"
