<div>
	...
	<x-jet-form-section submit="save">
		...
		<x-slot name="description">
			{{ __('Tambah absensi perizinan guru.') }}
		</x-slot>
		
		<x-slot name="form">
			<!-- Signed_at -->
			<div class="col-span-6">
				<x-jet-label for="signed_at">{{ __('Tanggal Perizinan (dd/mm/yyyy)') }}<x-required /></x-jet-label>
			...
			<!-- Category -->
			<div class="col-span-6">
				<x-jet-label for="category">{{ __('Izin Karena') }}<x-required /></x-jet-label>
			...
			<!-- Started_at -->
			<div class="col-span-6">
				<x-jet-label for="started_at">{{ __('Dari Tanggal (dd/mm/yyyy)') }}<x-required /></x-jet-label>
			...
			<!-- Ended_at -->
			<div class="col-span-6">
				<x-jet-label for="ended_at">{{ __('Sampai Tanggal (dd/mm/yyyy)') }}<x-required /></x-jet-label>
			...
			<div class="col-span-6">
				<x-jet-label for="search">{{ __('Guru yang Izin') }}<x-required /></x-jet-label>
