			...
			<tr>
				...
				<x-td class="text-right text-sm font-medium">
					<div class="flex space-x-4 flex-row justify-end">
						@can('u a evaluasi')
						<x-buttons.button-edit href="{{ route('evaluation.edit', $evaluation->id) }}"></x-buttons.button-edit>
						@endcan
						@can('d a evaluasi')
						<x-buttons.button-delete wire:click="confirmDelete({{ $evaluation->id }})"></x-buttons.button-delete>
						@endcan
					</div>
				</x-td>
			</tr>
