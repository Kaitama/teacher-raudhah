...
Route::prefix('/dashboard')->middleware(['auth:sanctum', 'verified'])->group(function () {
	...
	Route::get('/teachers/show/{id}', function ($id) {
		return view('teacher.show', ['id' => $id]);
	})->name('teacher.show')->middleware(['permission:r a guru']);
	...
	Route::get('/gathering/edit/{id}', function ($id) {
		return view('attendance.gathering.edit', ['id' => $id]);
	})->name('gathering.edit')->middleware(['can:u a kumpul']);
	Route::get('/gathering/show/{id}', function ($id) {
		return view('attendance.gathering.show', ['id' => $id]);
	})->name('gathering.show')->middleware(['can:r a kumpul']);
	...
	Route::get('/permit/edit/{id}', function ($id) {
		return view('attendance.permit.edit', ['id' => $id]);
	})->name('permit.edit')->middleware(['can:u a perizinan']);
	...
	Route::get('/assignment/edit/{id}', function ($id) {
		return view('attendance.assignment.edit', ['id' => $id]);
	})->name('assignment.edit')->middleware(['can:u a penugasan']);
	...
	Route::get('/teaching/edit/{id}', function ($id) {
		return view('attendance.teaching.edit', ['id' => $id]);
	})->name('teaching.edit')->middleware(['can:u a absensi']);
	...
	Route::get('/evaluation/edit/{id}', function ($id) {
		return view('attendance.evaluation.edit', ['id' => $id]);
	})->name('evaluation.edit')->middleware(['can:u a evaluasi']);

	// TICKET
	Route::view('/ticket/index', 'attendance.ticket.index')->name('ticket.index')->middleware(['can:r a tiket']);
	Route::view('/ticket/create', 'attendance.ticket.create')->name('ticket.create')->middleware(['can:c a tiket']);
	Route::get('/ticket/edit/{id}', function ($id) {
		return view('attendance.ticket.edit', ['id' => $id]);
	})->name('ticket.edit')->middleware(['can:u a tiket']);

	// SCORING
	Route::get('/scoring/index/{id}', function ($id) {
		return view('scoring.index', ['id' => $id]);
	})->name('scoring.index')->middleware(['can:m a penilaian']);
	Route::get('/scoring/create/{id}', function ($id) {
		return view('scoring.create', ['id' => $id]);
	})->name('scoring.create')->middleware(['can:c a penilaian']);
	...
	Route::get('/history/index/{id}', function ($id) {
		return view('teacher.history-index', ['id' => $id]);
	})->name('teacher.history.index');
	...
	Route::group(['middleware' => ['role:developer']], function () {
		Route::get('/permission/index', function () {
			return view('developer.permission.index');
